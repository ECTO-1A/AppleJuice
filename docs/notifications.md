...
`python3 app.py --device-name "AppleTV Connecting..."`
...
`python3 app.py --device-name "AppleTV Join This AppleTV"`
...
`python3 app.py --device-name "Setup New iPhone"`
...
`python3 app.py --device-name "AppleTV Color Balance"`

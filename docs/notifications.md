...
`python3 app.py -ap -d "AppleTV AppleID Setup"`
...
`python3 app.py -ap -d "AppleTV Wireless Audio Sync"`
...
`python3 app.py -ap -d "AppleTV HomeKit Setup"`
...
`python3 app.py -ap -d "AppleTV Keyboard"`

> **Message**: AppleTV Keyboard Password AutoFill

<img src="https://github.com/ECTO-1A/AppleJuice/assets/112792126/2f286048-774d-42aa-85af-03d6153afbef" width="300"><br><br>

`python3 app.py -ap -d "AppleTV Connecting..."`
...
`python3 app.py -ap -d "AppleTV Color Balance"`
